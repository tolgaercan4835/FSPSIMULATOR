        ...
        >
            ...
            >
                <header className="flex justify-between items-center p-4 border-b border-gray-700">
                    <h2 id="premium-title" className="text-xl font-bold text-gray-100 flex items-center">
                ...
                <div className="p-6">
                    ...
                    <button 
                        onClick={onConfirm}
                        className="w-full bg-green-500 text-white font-bold py-3 px-4 rounded-lg hover:bg-green-600 transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500/50 shadow-lg"
                    >
                        Erişimi Hemen Aç
                    </button>
                </div>
